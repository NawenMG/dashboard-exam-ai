...
async def create_submission(
    ...
    return await SubmissionService.create_submission(
        db, student=student, payload=payload
    )
...
async def list_submissions_by_exam(
    ...
    return await SubmissionService.list_by_exam_for_teacher_with_answers(
        db,
        teacher=teacher,
        exam_id=exam_id,
        page=page,
...
async def list_submissions_by_subject(
    ...
    return await SubmissionService.list_by_subject_for_teacher(
        db,
        teacher=teacher,
        subject=subject,
        page=page,
...
async def list_submissions_by_student(
    ...
    return await SubmissionService.list_by_student_scoped(
        db,
        user=user,
